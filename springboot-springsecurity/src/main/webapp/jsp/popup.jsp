...
<div id="title" class="title"><img src="/picture/off.jpg" alt="关闭" />居中窗口</div> 
<div class="content">居中窗口。。。</div> 
   </div> 

  <div class="window" id="left"> 
<div id="title2" class="title"><img src="/picture/off.jpg" alt="关闭" />居左窗口</div> 
<div class="content">居左窗口。。。</div> 
  </div> 
  <div class="window" id="right"> 
<div id="title3" class="title"><img src="/picture/off.jpg" alt="关闭" />居右窗口</div> 
