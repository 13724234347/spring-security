...
<body>
	<security:authorize buttonMethod="put" buttonUrl="/role/**">
		...
		<c:if test="${value=='add'}">
			 <div id="div">
				<form:form action="${pageContext.request.contextPath}/role/role" method="post" modelAttribute="role">
					<table>
						<tr>
							<td>&nbsp;&nbsp;&nbsp;role:</td>
							<td>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		var title = "";
		if(value=="add"){
			title = "<h2>欢迎来到角色添加页面</h2>";
		} else if(value=="update"){
			title = "<h2>欢迎来到角色修改页面</h2>";
		}
		$("#p").append(title);
	});
</script>
